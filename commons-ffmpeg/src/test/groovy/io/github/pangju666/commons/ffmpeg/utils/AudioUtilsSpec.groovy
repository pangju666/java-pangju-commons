...
class AudioUtilsSpec extends Specification {
	...
	def "转码到文件 - 指定输出配置"() {
		...
		resource.getAudio().getDuration() == outputResource.getAudio().getDuration()
		outputResource.getAudio().getCodecId() == avcodec.AV_CODEC_ID_MP3
		outputResource.getAudio().getFormat() == FFmpegConstants.AUDIO_MP3_FORMAT
	...
	def "裁剪到文件 - 从开头裁剪指定时长"() {
		...
		//outputResource.getAudio().getDuration() == resource.getAudio().getDuration() - duration
		outputResource.getAudio().getCodecId() == resource.getAudio().getCodecId()
		outputResource.getAudio().getFormat() == resource.getAudio().getFormat()
	...
	def "裁剪到文件 - 指定时间段"() {
		...
		//outputResource.getAudio().getDuration() == resource.getAudio().getDuration() - (end - start)
		outputResource.getAudio().getCodecId() == resource.getAudio().getCodecId()
		outputResource.getAudio().getFormat() == resource.getAudio().getFormat()
	...
	def "拼接 - 指定输出配置"() {
		...
		//outputResource.getAudio().getDuration() == resource1.getAudio().getDuration() + resource2.getAudio().getDuration()
		outputResource.getAudio().getCodecId() == avcodec.AV_CODEC_ID_MP3
		outputResource.getAudio().getFormat() == FFmpegConstants.AUDIO_MP3_FORMAT
	}
	...
	def "添加背景音乐 - 使用默认权重和源配置"() {
		...
		outputResource.getAudio().getDuration() == mainResource.getAudio().getDuration()
		outputResource.getAudio().getCodecId() == mainResource.getAudio().getCodecId()
		outputResource.getAudio().getFormat() == mainResource.getAudio().getFormat()
	}
	...
	def "调整速度 - 使用源配置"() {
		...
		//outputResource.getAudio().getDuration() == resource.getAudio().getDuration().dividedBy(2)
		outputResource.getAudio().getCodecId() == resource.getAudio().getCodecId()
		outputResource.getAudio().getFormat() == resource.getAudio().getFormat()
	...
	def "调整速度 - 指定输出配置"() {
		...
		!outputResource.getAudio().getDuration().isZero() && !outputResource.getAudio().getDuration().isNegative()
		outputResource.getAudio().getCodecId() == avcodec.AV_CODEC_ID_MP3
		outputResource.getAudio().getFormat() == FFmpegConstants.AUDIO_MP3_FORMAT
	...
	def "调整音量 - 使用源配置"() {
		...
		outputResource.getAudio().getDuration() == outputResource.getAudio().getDuration()
		outputResource.getAudio().getCodecId() == resource.getAudio().getCodecId()
		outputResource.getAudio().getFormat() == resource.getAudio().getFormat()
