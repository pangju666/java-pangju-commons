...
public class Audio extends Media {
	 ...
	 * @since 1.1.0
	 */
	public static Audio.Builder wav() {
		return new Audio.Builder(FFmpegConstants.AUDIO_WAV_FORMAT)
	 ...
	 * @since 1.1.0
	 */
	public static Audio.Builder flac() {
		return new Audio.Builder(FFmpegConstants.AUDIO_FLAC_FORMAT)
	 ...
	 * @since 1.1.0
	 */
	public static Audio.Builder mp3() {
		return new Audio.Builder(FFmpegConstants.AUDIO_MP3_FORMAT)
	 ...
	 * @since 1.1.0
	 */
	public static Audio.Builder opus() {
		return new Audio.Builder(FFmpegConstants.AUDIO_OPUS_FORMAT)
	 ...
	 * @since 1.1.0
	 */
	public static Audio.Builder aac() {
		return new Audio.Builder(FFmpegConstants.AUDIO_AAC_FORMAT)
	 ...
	 * @since 1.1.0
	 */
	public static Audio.Builder builder(String format) {
		return new Audio.Builder(format);
	}
	...
	public static Audio.Builder builder(FFmpegFrameGrabber grabber) throws FFmpegFrameGrabber.Exception {
		return new Audio.Builder(grabber);
	}
	 ...
	 * @since 1.1.0
	 */
	public static Audio.Builder builder(FFmpegResource resource) throws IOException {
