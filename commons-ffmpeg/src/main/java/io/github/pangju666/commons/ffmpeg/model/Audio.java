 ...
 * System.out.println("声道数: " + audio.getChannels());
...
public class Audio {
	...
	protected Audio(String format, Map<String, String> metadata, String codecName, int codecId, Duration duration,
	...
	public void setAudioMetadata(Map<String, String> audioMetadata) {
		this.audioMetadata = audioMetadata;
	}
}
