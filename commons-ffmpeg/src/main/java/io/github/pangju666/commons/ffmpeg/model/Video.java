 ...
 * System.out.println("分辨率: " + video.imageWidth() + "x" + video.imageHeight());
 * System.out.println("帧率: " + video.frameRate());
 ...
 *
 * @param format 视频格式
 * @param metadata 视频元数据映射
 * @param codecName 视频编解码器名称
 * @param codecId 视频编解码器 ID
 * @param duration 视频时长
 ...
 * @param videoMetadata 视频专用元数据映射
 * @param audio 音频信息（如果视频包含音频）
 * @author pangju666
 * @since 2.1.0
 */
public record Video(String format, Map<String, String> metadata, String codecName, int codecId, Duration duration,
