...
class RSAIntegerNumberEncryptorTest extends Specification {
	RSAKey key
	...
	def "test"() {
		...
		when:
		BigInteger encryptNumber = encryptor.encrypt(BigInteger.valueOf(message))
		def result = encryptor.decrypt(encryptNumber)
