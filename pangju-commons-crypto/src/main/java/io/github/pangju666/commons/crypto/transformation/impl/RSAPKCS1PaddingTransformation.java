...
/**
 * RSA 加密转换方案实现类，使用 PKCS#1 v1.5 填充模式
 * <p>
 * 本实现类对应算法名称为 "RSA/ECB/PKCS1Padding"，具有以下特性：
 * <ul>
 *   <li>加密分块大小计算公式：模数长度/8 - 11（单位：字节）</li>
 *   <li>解密分块大小使用默认实现：模数长度/8</li>
 *   <li>遵循 PKCS#1 v1.5 填充规范（推荐用于兼容旧系统，新系统建议使用 OAEP 填充）</li>
 * </ul>
 *
 * @author pangju666
...
public class RSAPKCS1PaddingTransformation implements RSATransformation {
	 ...
	 * 获取完整的算法转换方案名称
	 *
	 * @return 固定返回 "RSA/ECB/PKCS1Padding"
	 * @since 1.0.0
	 */
	@Override
	...
	/**
	 * 计算 PKCS#1 v1.5 填充模式下的加密分块尺寸
	 * <p>
	 * 计算公式：模数位长度/8 - 11（对应 11 字节的填充开销）
	 *
