...
public class WorkbookUtils {
	private static final String HSSF_MIME_TYPE = "application/vnd.ms-excel";
	private static final String XSSF_MIME_TYPE = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
