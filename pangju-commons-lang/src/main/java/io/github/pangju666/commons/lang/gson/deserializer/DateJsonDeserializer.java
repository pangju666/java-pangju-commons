 ...
 * <p>
 * 该反序列化器用于将 JSON 数值元素（表示时间戳）转换为 Date 对象。
 ...
 *
 * // 反序列化示例
 * Date date = gson.fromJson("1640995200000", Date.class); // 2022-01-01 00:00:00
 * }</pre>
 * </p>
 *
 * @author pangju666
...
public class DateJsonDeserializer implements JsonDeserializer<Date> {
	 ...
	 *     <li>使用 {@link DateUtils#toDate(Long)} 将时间戳转换为 {@link Date} 对象</li>
	 * </ol>
	 * </p>
	 *
	 ...
	 * @return 转换后的 Date 对象，如果输入不是数值类型则返回 null
