...
/**
 * 数据大小，如 "12MB"。该类以字节为单位模拟数据大小，不可变且线程安全。
 *
 * <p>
 * 该类中使用的术语和单位基于<a href="https://en.wikipedia.org/wiki/Binary_prefix">二进制前缀</a>，
 * 表示乘以 2 的幂。
 * </p>
 * <p>
 * 详情请参考下表和 {@link DataUnit} 的 Javadoc。
 * </p>
 *
 * <p>
 * <table border="1">
 * <tr><th>术语</th><th>符号表示</th><th>大小（字节）</th></tr>
 * <tr><td>字节</td><td>1B</td><td>1</td></tr>
 * <tr><td>千字节</td><td>1KB</td><td>1,024</td></tr>
 * <tr><td>兆字节</td><td>1MB</td><td>1,048,576</td></tr>
 * <tr><td>千兆字节</td><td>1GB</td><td>1,073,741,824</td></tr>
 * <tr><td>太字节</td><td>1TB</td><td>1,099,511,627,776</td></tr>
 * </table>
 * </p>
 *
 * <p>
 *     代码来源于：org.springframework.util.unit.DataSize
 * </p>
 *
...
public final class DataSize implements Comparable<DataSize>, Serializable {
	...
	public static DataSize parse(CharSequence text, @Nullable DataUnit defaultUnit) {
		...
		try {
			...
			Validate.isTrue(matcher.matches(), "'" + text + "' does not match data size pattern");
