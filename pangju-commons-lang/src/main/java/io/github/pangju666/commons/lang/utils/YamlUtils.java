...
public class YamlUtils {
    ...
    public static Map<String, Object> parseYamlAsMap(final File yamlFile) throws IOException {
        Yaml yaml = new Yaml();
    ...
    public static <T> T getValue(final String key, final File yamlFile) throws IOException {
    ...
    public static boolean existKey(final String key, final File yamlFile) throws IOException {
