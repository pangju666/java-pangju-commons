...
public class ImageUtils {
	...
	public static boolean isImage(final byte[] bytes) {
		...
		return StringUtils.startsWith(IOConstants.getDefaultTika().detect(bytes), IOConstants.IMAGE_MIME_TYPE_PREFIX);
	}
	...
	public static boolean isImage(final InputStream inputStream) throws IOException {
		...
		return StringUtils.startsWith(IOConstants.getDefaultTika().detect(inputStream), IOConstants.IMAGE_MIME_TYPE_PREFIX);
	}
