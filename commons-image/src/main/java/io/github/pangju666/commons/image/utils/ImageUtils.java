...
public class ImageUtils {
	...
	public static BufferedImage correctOrientation(final BufferedImage image, final int exifOrientation) {
		...
		return switch (exifOrientation) {
			case 2 -> ImageUtil.createFlipped(image, FlipDirection.HORIZONTAL.getAxis());
			case 3 -> ImageUtil.createRotated(image, RotateDirection.UPSIDE_DOWN.getRadians());
			case 4 -> ImageUtil.createFlipped(image, FlipDirection.VERTICAL.getAxis());
			case 5 -> {
				BufferedImage clockwise90Image = ImageUtil.createRotated(image,
					RotateDirection.CLOCKWISE_90.getRadians());
				yield ImageUtil.createFlipped(clockwise90Image, FlipDirection.HORIZONTAL.getAxis());
			}
			case 6 -> ImageUtil.createRotated(image, RotateDirection.CLOCKWISE_90.getRadians());
			case 7 -> {
				BufferedImage counterClockwise90Image = ImageUtil.createRotated(image,
					RotateDirection.COUNTER_CLOCKWISE_90.getRadians());
				yield ImageUtil.createFlipped(counterClockwise90Image, FlipDirection.HORIZONTAL.getAxis());
			}
			case 8 -> ImageUtil.createRotated(image, RotateDirection.COUNTER_CLOCKWISE_90.getRadians());
			default -> image;
		};
	}
