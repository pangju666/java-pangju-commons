...
public enum WatermarkDirection {
	...
	public Coordinate toCoordinate(ImageSize imageSize, int watermarkWidth, int watermarkHeight) {
		switch (this) {
			case TOP:
				return new Coordinate((imageSize.getWidth() - watermarkWidth) / 2, 0);
			case TOP_LEFT:
				return new Coordinate(0, 0);
			case TOP_RIGHT:
				return new Coordinate(imageSize.getWidth() - watermarkWidth, 0);
			case BOTTOM:
				return new Coordinate((imageSize.getWidth() - watermarkWidth) / 2,
					imageSize.getHeight() - watermarkHeight);
			case BOTTOM_LEFT:
				return new Coordinate(0, imageSize.getHeight() - watermarkHeight);
			case BOTTOM_RIGHT:
				return new Coordinate(imageSize.getWidth() - watermarkWidth,
					imageSize.getHeight() - watermarkHeight);
			case LEFT:
				return new Coordinate(0, (imageSize.getHeight() - watermarkHeight) / 2);
			case RIGHT:
				return new Coordinate(imageSize.getWidth() - watermarkWidth,
