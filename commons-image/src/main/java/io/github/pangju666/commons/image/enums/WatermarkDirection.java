...
public enum WatermarkDirection {
	...
	public Coordinate toWatermarkCoordinate(ImageSize imageSize, ImageSize watermarkImageSize) {
		return switch (this) {
			case TOP -> new Coordinate((imageSize.getWidth() - watermarkImageSize.getWidth()) / 2,
				watermarkImageSize.getHeight());
			case TOP_LEFT -> new Coordinate(0, watermarkImageSize.getHeight());
			case TOP_RIGHT -> new Coordinate(imageSize.getWidth() - watermarkImageSize.getWidth(),
				watermarkImageSize.getHeight());
			case BOTTOM -> new Coordinate((imageSize.getWidth() - watermarkImageSize.getWidth()) / 2,
				imageSize.getHeight());
			case BOTTOM_LEFT -> new Coordinate(0, imageSize.getHeight());
			case BOTTOM_RIGHT -> new Coordinate(imageSize.getWidth() - watermarkImageSize.getWidth(),
				imageSize.getHeight());
